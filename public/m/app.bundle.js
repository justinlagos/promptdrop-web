...
function CleanPreview({ url, removed, rate, filterCss, active, vref }) {
  ...
  const kept = React.useMemo(() => ctKept(1e9, removed).map((k) => k), [removed]);
  ...
  return /* @__PURE__ */ React.createElement("video", { ref, src: url, playsInline: true, controls: true, preload: "metadata", onTimeUpdate: active ? onTime : void 0, style: { width: "100%", height: "100%", objectFit: "cover", background: "#000", filter: filterCss || "none" } });
}
